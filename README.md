...
To flash the digispark module, you need to add below link to your boards maneger
Arduino > File > Preferences > Additional Boards Manager URLs:
https://raw.githubusercontent.com/digistump/arduino-boards-index/master/package_digistump_index.json

Once the link is added, head over to Tools > Bord > Boards Manager, search for 
